...
const config = {
    apiKey: "AIzaSyDPqs7qi77kmx6l7EZoiMqe7maKTS0nvNs",
    authDomain: "books-a6e92.firebaseapp.com",
    databaseURL: "https://books-a6e92.firebaseio.com",
    storageBucket: "books-a6e92.appspot.com",
};
